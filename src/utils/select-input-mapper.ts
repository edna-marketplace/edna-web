...
const orderStatusDisplayNames = {
  ...
  'COMPLETED': 'Concluído',
  'PENDING': 'Pendente',
  'AWAIT_WITHDRAWAL': 'Aguardando Retirada',
};
...
const categoryDisplayNames = {
  'ALL': 'Todos',
  'T_SHIRT': 'Camiseta',
  'SOCIAL_SHIRT': 'Camisa Social',
  'SUIT': 'Terno',
  'ACTIVEWEAR': 'Roupas Esportivas',
  'DRESS': 'Vestido',
  'PANTS': 'Calças',
  'SHORTS': 'Shorts',
  'JACKET_HOODIE': 'Jaquetas & Moletons',
...
export { genderDisplayNames, brandDisplayNames, categoryDisplayNames, sizeDisplayNames, orderStatusDisplayNames }
