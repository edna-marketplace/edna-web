...
import { FloatingLabel, FloatingLabelContainer, TextArea } from './styles'

export interface LabeledTextArea
  extends Omit<ComponentProps<typeof TextArea>, 'placeholder'> {
  label: string
}
