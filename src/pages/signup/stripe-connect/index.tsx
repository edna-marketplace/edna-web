        ...
        <FormContainer>
          ...
          <WhatsStripeContainer>
            ...
            <Text size={isMobile ? "sm" : "sm"} weight="regular">
              Usamos o Stripe para processar os pagamentos das suas peças
              vendidas de forma segura. Com ele, você recebe o valor das suas
              vendas diretamente na sua conta bancária, sem complicações.
            </Text>
          </WhatsStripeContainer>
