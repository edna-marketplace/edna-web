import { AlreadyHaveAccountContainer, ButtonContainer, Container, FormTitle, InputContainer, RegisterPasswordForm } from "./styles";
...
export default function RegisterPassword() {
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<RegisterPasswordFormData>({
  ...
  return (
    <Container>
      <RegisterPasswordForm onSubmit={handleSubmit(handleContinue)}>
        ...
        <InputContainer>
          <Text type="label" size="xs">Confirmar senha</Text>
          <TextInput
            maxLength={9}
